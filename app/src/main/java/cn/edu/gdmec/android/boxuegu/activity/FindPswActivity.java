...
public class FindPswActivity extends AppCompatActivity {
    ...
    //
    private String from;
    private TextView tv_reset_pw,tv_user_name;
    ...
    private void init(){
        ...
        tv_reset_pw = (TextView) findViewById(R.id.tv_reset_psw);
            ...
            public void onClick(View view) {
                ...
                if ("security".equals(from)) {
                    ...
                    if (TextUtils.isEmpty(userName)) {
                        Toast.makeText(FindPswActivity.this, "请输入您到用户名",
                                Toast.LENGTH_SHORT).show();
                        return;
                    ...
                    if (!validateName.equals(sp_security)) {
                        ...
                        //输入的密保正确，重新给用户设置一个密保
                        tv_reset_pw.setVisibility(View.VISIBLE);
                        tv_reset_pw.setText("初始密码：123456");
                        savePsw(userName);
                    }
                }
            }
